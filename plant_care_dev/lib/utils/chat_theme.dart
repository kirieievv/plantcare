...
class ChatTheme {
  ...
  static BoxDecoration bubbleDecoration({required bool isUser}) =>
      BoxDecoration(
        ...
        boxShadow: isUser
            ? [
                BoxShadow(
                  color: moss.withValues(alpha: 0.30),
                  blurRadius: 8,
  ...
  static BoxDecoration quickPillDecoration({bool hovered = false}) =>
      BoxDecoration(
  ...
  static BoxDecoration inputWrapDecoration({bool focused = false}) =>
      BoxDecoration(
        color: cream,
        border: Border.all(color: focused ? sageLt : sand, width: 1.5),
        borderRadius: BorderRadius.circular(22),
      );

  static BoxDecoration attachBtnDecoration({bool hovered = false}) =>
      BoxDecoration(
        shape: BoxShape.circle,
        border: Border.all(color: hovered ? sage : sand, width: 1.5),
      );
