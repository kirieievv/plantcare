...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get cycleJustStarted => 'Cycle just started';

  @override
  String cyclePercentComplete(int percent) {
    return 'Cycle $percent% complete';
  }

  @override
  String get wateringAmount => 'Amount';
  ...
  @override
  String get quizPotUnknown => 'I don\'t know — measure it from the photo';

  @override
  String addPlantPotFromPhoto(int cm) {
    return 'Pot size from the photo — about $cm cm';
  }

  @override
  String addPlantPotAverage(int cm) {
    return 'The pot isn\'t visible, so we took an average $cm cm';
  }
  ...
  @override
  String get chatCtxWaterToday => 'Watering due today';
