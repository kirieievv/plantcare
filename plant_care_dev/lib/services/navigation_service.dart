...
class NavigationService {
  ...
  static Future<void> savePlantDetailsState(String plantId) async {
    print(
      '🌱 NavigationService: Saving plant details state for plant: $plantId',
    );
  ...
  static Future<bool> shouldReturnToPlantDetails() async {
    ...
    print(
      '🌱 NavigationService: Should return to plant details? $shouldReturn (screen: $lastScreen, plantId: $lastPlantId)',
    );
    return shouldReturn;
  }
}
